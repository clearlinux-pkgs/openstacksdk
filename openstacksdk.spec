...
Version  : 0.7.3
Release  : 4
URL      : http://tarballs.openstack.org/python-openstacksdk/openstacksdk-0.7.3.tar.gz
Source0  : http://tarballs.openstack.org/python-openstacksdk/openstacksdk-0.7.3.tar.gz
