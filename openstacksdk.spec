...
Version  : 0.8.6
Release  : 14
URL      : http://tarballs.openstack.org/python-openstacksdk/openstacksdk-0.8.6.tar.gz
Source0  : http://tarballs.openstack.org/python-openstacksdk/openstacksdk-0.8.6.tar.gz
