...
%prep
%setup -q -n openstacksdk-0.38.0
cd %{_builddir}/openstacksdk-0.38.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1575384765
...
cp %{_builddir}/openstacksdk-0.38.0/LICENSE %{buildroot}/usr/share/package-licenses/openstacksdk/57aed0b0f74e63f6b85cce11bce29ba1710b422b
