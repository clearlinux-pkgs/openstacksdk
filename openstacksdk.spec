...
Version  : 0.7.0
Release  : 2
URL      : http://tarballs.openstack.org/python-openstacksdk/openstacksdk-0.7.0.tar.gz
Source0  : http://tarballs.openstack.org/python-openstacksdk/openstacksdk-0.7.0.tar.gz
