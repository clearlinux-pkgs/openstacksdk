...
Version  : 0.9.1
Release  : 16
URL      : http://tarballs.openstack.org/python-openstacksdk/openstacksdk-0.9.1.tar.gz
Source0  : http://tarballs.openstack.org/python-openstacksdk/openstacksdk-0.9.1.tar.gz
