...
Source0  : https://tarballs.openstack.org/openstacksdk/openstacksdk-0.42.0.tar.gz
Source1  : https://tarballs.openstack.org/openstacksdk/openstacksdk-0.42.0.tar.gz.asc
...
%prep
%setup -q -n openstacksdk-0.42.0
cd %{_builddir}/openstacksdk-0.42.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583775687
...
cp %{_builddir}/openstacksdk-0.42.0/LICENSE %{buildroot}/usr/share/package-licenses/openstacksdk/57aed0b0f74e63f6b85cce11bce29ba1710b422b
